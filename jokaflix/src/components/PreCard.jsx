...
const Card = ({ src, last, rating, category, year }) => {
  ...
  return (
    <div>
      <div className='card-container bg-gray-700 animate-pulse'>
        ...
        <div className='content'>
          ...
          {year && recent && (
            <div className='relative bg-orange-600 w-[90%] md:w-[80%] bottom-20 h-5 rounded md:h-6 flex items-center justify-center uppercase text-center text-xs md:text-md mx-auto text-white font-bold'>
              {recent}
            </div>
          )}
          <div>
