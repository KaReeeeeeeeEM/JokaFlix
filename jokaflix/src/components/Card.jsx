    ...
    <div>
      <div className='card-container' style={{ backgroundImage: `url(https://image.tmdb.org/t/p/w500${src})` }}>
        ...
        <div className='content'>
          ...
          {year && recent && (
            <div className='relative bg-orange-600 w-[80%] bottom-28 md:bottom-20 rounded-md md:h-6 flex items-center justify-center uppercase text-center text-sm md:text-md mx-auto text-white font-bold'>
              {recent}
            </div>
          )}
          <div>
